...
public class SecurityConfig {
    ...
    public PasswordEncoder passwordEncoder() {
        // [BCrypt] One-way, salted hash — never decrypted, only re-hashed for comparison
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // [CORS FIX] Cannot use wildcard "*" with allowCredentials(true) — browsers reject it.
        // Explicitly list all allowed origins instead.
        config.setAllowedOriginPatterns(List.of(
                "http://localhost:3000",   // local frontend (python http.server)
